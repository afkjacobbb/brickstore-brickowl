...
#define DisplayName "BrickStore BrickOwl Prototype"
#else
#define DisplayName "BrickStore"
#endif

[Setup]
#ifdef BRICKOWL_PROTOTYPE
AppId=BrickStoreBrickOwlPrototype
#endif
...
[Files]
#ifdef BRICKOWL_PROTOTYPE
Source: "*"; DestDir: "{app}"; Flags: recursesubdirs createallsubdirs ignoreversion; Excludes: "vc_redist.{#ARCH}.exe,*.pdb"
#else
...
[Icons]
Name: "{autoprograms}\{#DisplayName}"; Filename: "{app}\BrickStore.exe";

Name: "{autodesktop}\{#DisplayName}"; Filename: "{app}\BrickStore.exe"; Tasks: desktopicon

#ifndef BRICKOWL_PROTOTYPE
[Registry]
; Definition
