...
void ActionManager::initialize()
{
    ...
    A("document_import_bo_store_inv", QT_TR_NOOP("BrickOwl Store Inventory..."), nullptr, NeedNetwork);
    A("document_sync_marketplaces", QT_TR_NOOP("Synchronize BrickLink ↔ BrickOwl..."), nullptr, NeedDocument | NeedLots | NeedNetwork);
