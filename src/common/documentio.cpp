...
Document *DocumentIO::parseBsxInventory(QFile *in)
{
    ...
    try {
        ...
        auto parseInventory = [&]() {
            ...
            { u"BrickOwlLotID", [](auto *lot, auto &v) { lot->setBrickOwlLotId(v); } },
            { u"BrickOwlID", [](auto *lot, auto &v) { lot->setBrickOwlId(v); } },
            { u"BrickOwlColorID", [](auto *lot, auto &v) { lot->setBrickOwlColorId(v.toInt()); } },
            { u"BrickOwlCondition", [](auto *lot, auto &v) { lot->setBrickOwlCondition(v); } },
...
bool DocumentIO::createBsxInventory(QIODevice *out, const Document *doc)
{
    ...
    for (const auto *loopLot : lots) {
        ...
        create(u"BrickOwlLotID", &Lot::brickOwlLotId, asString, Optional, QString());
        create(u"BrickOwlID", &Lot::brickOwlId, asString, Optional, QString());
        create(u"BrickOwlColorID", &Lot::brickOwlColorId, asInt, Optional, -1);
        create(u"BrickOwlCondition", &Lot::brickOwlCondition, asString, Optional, QString());
