...
public:
    ...
    QString brickOwlApiKey() const { return m_brickOwlApiKey; }
    void setBrickOwlApiKey(const QString &key);
    QString brickLinkStoreApiCredentials() const { return m_brickLinkStoreApiCredentials; }
    void setBrickLinkStoreApiCredentials(const QString &json);
...
private:
    ...
    QString m_brickOwlApiKey;
    QString m_brickLinkStoreApiCredentials;
