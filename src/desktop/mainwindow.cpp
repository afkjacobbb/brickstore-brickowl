...
void MainWindow::createActions()
{
    ...
    ActionManager::ActionTable actionTable = {
        ...
        { "document_import_bo_store_inv", [this](bool) {
              BrickOwlDialog dialog(nullptr, this);
              dialog.exec();
          } },
        { "document_sync_marketplaces", [this](bool) {
              if (m_activeView && m_activeView->document()) {
                  BrickOwlDialog dialog(m_activeView->document(), this);
                  dialog.exec();
              }
          } },
