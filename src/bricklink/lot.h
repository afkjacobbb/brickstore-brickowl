...
public:
    ...
    QString brickOwlLotId() const { return m_brickOwlLotId; }
    void setBrickOwlLotId(const QString &id) { m_brickOwlLotId = id; }
    QString brickOwlId() const { return m_brickOwlId; }
    void setBrickOwlId(const QString &id) { m_brickOwlId = id; }
    int brickOwlColorId() const { return m_brickOwlColorId; }
    void setBrickOwlColorId(int id) { m_brickOwlColorId = id; }
    QString brickOwlCondition() const { return m_brickOwlCondition; }
    void setBrickOwlCondition(const QString &condition) { m_brickOwlCondition = condition; }
...
private:
    ...
    uint    m_lot_id = 0;
    QString m_brickOwlLotId;
    QString m_brickOwlId;
    int m_brickOwlColorId = -1;
    QString m_brickOwlCondition;
    QString m_reserved;
